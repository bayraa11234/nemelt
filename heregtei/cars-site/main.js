                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-end gap-3">
                            <button type="buton" class="btn btn-success" onclick="updateCar(${car.id})">Засах</button>
                            <button type="buton" class="btn btn-danger" onclick="deleteCar(${car.id})">Устгах</button>
                        </div>
                    </div>
                </div>
            </div>
...
const updateCar = (id) => {
    ...
    .then((res) => res.json())
    .then((data)=>
    imageUrlTarget.value = data.imageUrl
    );
};